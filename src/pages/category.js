...
const getCategoryName = (markdown, url) => {
  ...
  let tocEntry = parsed.children[indexOfToCHeading + 1].children.find(
    child => child.children[0].children[0].url.substring(1) === url
  );
  ...
  <StaticQuery
    ...
    render={data => (
      <Layout>
        ...
        {getCategoryName(
          data.github.repository.content.text,
